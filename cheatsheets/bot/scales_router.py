...
Одна команда — /scales. Открывает отдельное мини-приложение: nSOFA, NEOMOD,
Сарнат, NIPS, N-PASS и VIS с подсчётом суммы и трактовкой. Питание живёт в своём приложении,
...
INTRO = (
    ...
    "<b>VIS</b> — вазоактивно-инотропный индекс: вводишь дозы, которые идут "
    "сейчас, приложение считает сумму по формуле Gaies.\n\n"
    "<b>NEOMOD</b> — вторая шкала полиорганной дисфункции из тех же КР, "
    "в двух версиях: исходной и модифицированной.\n\n"
    "<b>Сарнат</b> — стадия гипоксически-ишемической энцефалопатии: отмечаешь "
    "признаки, приложение показывает, какая стадия преобладает.\n\n"
